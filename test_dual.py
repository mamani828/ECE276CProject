...
def mark_dual_arm_goals(robot_id, left_indices, right_indices, left_ee, right_ee, goal_config):
    """
    ...
    # 5. Add Labels
    p.addUserDebugText("Left EE", [pos_left[0], pos_left[1], pos_left[2]+0.15], [0,1,1])
    p.addUserDebugText("Right EE", [pos_right[0], pos_right[1], pos_right[2]+0.15], [1,0,1])
...
if __name__ == "__main__":
    ...
    robot_id = p.loadURDF("dual_three_link_robot.urdf", [0, 0, 0], useFixedBase=True, flags=p.URDF_USE_INERTIA_FROM_FILE)
